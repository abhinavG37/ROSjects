...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name helloWorld-msg:<num> is deprecated: use helloWorld-msg:num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:num-val is deprecated.  Use helloWorld-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:first_name-val is deprecated.  Use helloWorld-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:last_name-val is deprecated.  Use helloWorld-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:age-val is deprecated.  Use helloWorld-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:score-val is deprecated.  Use helloWorld-msg:score instead.")
  (score m))
